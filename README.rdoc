...
See the examples[https://github.com/ltello/dci-ruby/tree/master/example] folder for examples of use and the DCI-Sample[https://github.com/ltello/DCI-Sample] repository for a sample application using DCI througth this gem.
